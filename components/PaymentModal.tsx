    ...
    <div className="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="confirmation-title">
      <section className="modal">
        ...
        {whatsappOpened ? <>
          ...
          <h2 id="confirmation-title" className="display" ref={thankYouHeading} tabIndex={-1}>Thank you for your order!</h2>
          <p className="modal-copy" style={{ marginTop: 16 }}>We look forward to making your matcha. If we need any more details, we’ll contact you on WhatsApp at <strong>{order.mobile}</strong>.</p>
          <p className="modal-copy">Please make sure you press <strong>Send</strong> in WhatsApp to share your order with us.</p>
          <p className="modal-copy">Your order reference: <strong>{order.orderId}</strong></p>
        </> : <>
        <div aria-hidden="true" style={{ fontSize: 34 }}>💬</div>
